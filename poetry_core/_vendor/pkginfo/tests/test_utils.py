...
class Test_get_metadata(unittest.TestCase):
    ...
    def _callFUT(self, path, metadata_version=None):
        from poetry_core._vendor.pkginfo.utils import get_metadata
    ...
    def test_w_module(self):
        from poetry_core._vendor.pkginfo.tests import _defaultMetadataVersion
        EXPECTED =  _defaultMetadataVersion()
        from poetry_core._vendor import pkginfo
        from poetry_core._vendor.pkginfo.tests import _checkSample
    ...
    def test_w_module_and_metadata_version(self):
        from poetry_core._vendor import pkginfo
        from poetry_core._vendor.pkginfo.tests import _checkSample
        from poetry_core._vendor.pkginfo.tests import _checkClassifiers
