...
from poetry_core._vendor.pyrsistent._checked_types import optional as optional_type
from poetry_core._vendor.pyrsistent._checked_types import wrap_invariant
import inspect
