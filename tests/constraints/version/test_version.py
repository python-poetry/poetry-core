...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("1.0.0-beta.1", Version.from_parts(1, 0, 0, pre=ReleaseTag("beta", 1)), "1.0.0b1"),
        ("1.0.0+1", Version.from_parts(1, 0, 0, local=1), "1.0.0+1"),
        ("1.0.0-1", Version.from_parts(1, 0, 0, post=ReleaseTag("post", 1)), "1.0.0.post1"),
        ("1.0.0.0", Version.from_parts(1, 0, 0, extra=0), "1.0.0.0"),
        ("1.0.0-post", Version.from_parts(1, 0, 0, post=ReleaseTag("post")), "1.0.0.post0"),
        ("1.0.0-post1", Version.from_parts(1, 0, 0, post=ReleaseTag("post", 1)), "1.0.0.post1"),
