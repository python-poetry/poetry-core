...
class Test__parse_options(unittest.TestCase):
    ...
    def _callFUT(self, args):
        from poetry.core._vendor.pkginfo.commandline import _parse_options
        return _parse_options(args)

    def test_empty(self):
        import io
        import sys
        from poetry.core._vendor.pkginfo.commandline import __doc__ as usage
...
class BaseTests(unittest.TestCase):
    ...
    def _getTargetClass(self):
        from poetry.core._vendor.pkginfo.commandline import Base
        return Base
...
class SimpleTests(unittest.TestCase, _FormatterBase):
    ...
    def _getTargetClass(self):
        from poetry.core._vendor.pkginfo.commandline import Simple
        return Simple
...
class SingleLineTests(unittest.TestCase, _FormatterBase):
    ...
    def _getTargetClass(self):
        from poetry.core._vendor.pkginfo.commandline import SingleLine
        return SingleLine
...
class CSVTests(unittest.TestCase, _FormatterBase):
    ...
    def _getTargetClass(self):
        from poetry.core._vendor.pkginfo.commandline import CSV
        return CSV
...
class INITests(unittest.TestCase, _FormatterBase):
    ...
    def _getTargetClass(self):
        from poetry.core._vendor.pkginfo.commandline import INI
        return INI
...
class JSONtests(unittest.TestCase, _FormatterBase):
    ...
    def _getTargetClass(self):
        from poetry.core._vendor.pkginfo.commandline import JSON
        return JSON
...
class Test_main(unittest.TestCase):
    ...
    def _callFUT(self, args, monkey='simple'):
        from poetry.core._vendor.pkginfo.commandline import main
        from poetry.core._vendor.pkginfo.commandline import _FORMATTERS
    ...
    def test_w_mising_dist(self):
        from poetry.core._vendor.pkginfo import commandline as MUT
