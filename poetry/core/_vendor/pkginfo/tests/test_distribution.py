...
class DistributionTests(unittest.TestCase):
    ...
    def _getTargetClass(self):
        from poetry.core._vendor.pkginfo.distribution import Distribution
        return Distribution
    ...
    def test_parse_Metadata_Version_1_0(self):
        from poetry.core._vendor.pkginfo.distribution import HEADER_ATTRS_1_0
        dist = self._makeOne(None)
    ...
    def test_parse_Metadata_Version_1_1(self):
        from poetry.core._vendor.pkginfo.distribution import HEADER_ATTRS_1_1
        dist = self._makeOne(None)
    ...
    def test_parse_Metadata_Version_1_2(self):
        from poetry.core._vendor.pkginfo.distribution import HEADER_ATTRS_1_2
        dist = self._makeOne(None)
    ...
    def test_parse_Metadata_Version_2_1(self):
        from poetry.core._vendor.pkginfo.distribution import HEADER_ATTRS_2_1
        dist = self._makeOne(None)
    ...
    def test_parse_given_unicode(self):
        from poetry.core._vendor.pkginfo._compat import u
        dist = self._makeOne()
