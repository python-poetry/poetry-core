...
def _cmpkey(
    ...
    int,
    Tuple[int, ...],
    Union[Union["Infinity", "NegativeInfinity", Tuple[str, int]], Any],
    Union["NegativeInfinity", Tuple[str, int]],
    Union[Union["Infinity", Tuple[str, int]], Any],
    Union[
        "NegativeInfinity",
        Tuple[Union[Tuple[int, str], Tuple["NegativeInfinity", Union[str, int]]], ...],
    ],
]:
